      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '3nawsi6m' /* Welcome back, please log in to... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'kthfhdv4' /* Enter your email address */,
                              ),
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.resultUser?.email != null &&
                                  _model.resultUser?.email != '') {
                              ...
                              FFAppState().name =
                                  _model.resultUser!.displayName;
                              FFAppState().update(() {});
                              if (_model.resultUser?.role == 'Passenger') {
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text: FFLocalizations.of(context).getText(
                            '0vqfai2r' /* Don’t have an account?  */,
                          ),
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
            ...
            ].divide(SizedBox(height: 22.0)).addToStart(SizedBox(height: 20.0)),
          ),
        ),
      ),
    );
